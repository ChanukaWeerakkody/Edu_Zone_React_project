...
exports.isAuthenticated = (0, catchAsyncErrors_1.CatchAsyncError)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!access_token) {
                    return [2 /*return*/, next(new ErrorHandler_1.default("Please login to access this resource", 401))];
                }
                decoded = jwt.verify(access_token, process.env.ACCESS_TOKEN);
                if (!decoded) {
                    return [2 /*return*/, next(new ErrorHandler_1.default("Access token is not valid", 401))];
                }
                return [4 /*yield*/, redis_1.redis.get(decoded.id)];
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, next(new ErrorHandler_1.default("User not found", 401))];
                }
